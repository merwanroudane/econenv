...
|---|---|---|
| **1.4.1** | [PyPI](https://pypi.org/project/econenv/1.4.1/) · [notes](https://github.com/merwanroudane/econenv/blob/main/CHANGELOG.md#141--2026-09-08) | GAUSS plots were saved onto a 4mm canvas |
| 1.4.0 | [PyPI](https://pypi.org/project/econenv/1.4.0/) · [notes](https://github.com/merwanroudane/econenv/blob/main/CHANGELOG.md#140--2026-09-08) | EconLang: state the model once, choose the engine |
