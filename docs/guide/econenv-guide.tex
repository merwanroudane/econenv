...
\title{
  ...
  {\large\bfseries Installation and User Guide}
}
...
Package: \url{https://pypi.org/project/econenv/}
\end{center}
...
The notebook \texttt{examples/10_real_data_four_engines.ipynb} works through a
