...
Each cell is a fresh process, so EconEnv carries the \emph{values} across using
GAUSS's own \texttt{save} and \texttt{load}. \textbf{Procedures,
\texttt{\#include}s and library loads do not carry} --- define a \texttt{proc}
