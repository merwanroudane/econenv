...
\newcommand{\econenvversion}{1.1.1}
...
from a computer with no Python on it and finishes with all five programs
...
EconEnv turns the five programs into \emph{execution engines behind one Python
kernel}. You write:
...
\begin{lstlisting}
EconEnv 1.1.1 loaded - one notebook, multiple econometric engines.
  %econ                  econenv
  %Rec / %%Rec           econenv
...
\section{All five engines, still in Colab}
...
Compare all five & EconEnv & one specification, five engines, one table \\
\bottomrule
\end{tabular}
\end{center}
